...
- [**Clase 4**]((https://github.com/eugenia1984/React-desde-cero-con-MiduDev/blob/main/clase04.md)),  hacemos una **prueba tecnica para Juniors**, viendo: ⭐ **React Hooks**: useRef, useMemo, useCallback, como manejar formularios (manera controlada y no controlada) y hacer debounce.
